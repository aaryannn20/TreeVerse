const apiKey = 'a4bdec27774962690e7f660033042bec' // this app uses the free tier of OpenWeather API, so to use this app, simply sign up for the free tier and enter the api key. (I deleted the original script.js file and replaced it with this one because I realized that I exposed my API key in the old one.)
